...
def plot_industry_share(results_demand_csv, nodes_csv,
    ...
    """
    Horizontal bar chart of demand share per industry.
    """
    ...
    industry_df = df.groupby("industry")[value_col].sum().reset_index()
    industry_df = industry_df[industry_df[value_col] > 0]
    industry_df = industry_df.sort_values(value_col, ascending=True)  # ascending for horizontal bars
